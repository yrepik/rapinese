	...
	<div ng-app="home">
		...
		<div id="icons" class="row mt20">
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="text-center"><i class="fa fa-4x fa-graduation-cap bg-info"></i></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="text-center"><i class="fa fa-4x fa-check bg-success"></i></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="text-center"><i class="fa fa-4x fa-refresh bg-warning"></i></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<div class="text-center"><i class="fa fa-4x fa-globe bg-danger"></i></div>
